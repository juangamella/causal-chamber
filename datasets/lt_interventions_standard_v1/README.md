...
| l_11_mid<br>l_12_mid<br>l_21_mid<br>l_22_mid<br>l_31_mid<br>l_32_mid<br> | [`generators/uniform.py`](generators/uniform.py) | We sample $L_{11} / L_{12} / L_{21} / L_{22} / L_{31} / L_{32} \overset{\text{i.i.d.}}{\sim} \text{Unif}(\\{171,\ldots,255\\})$ and sample all other manipulable variables as in `uniform_reference`. We collect $N = 1000$ measurements. |
| diode_vis_1_mid<br>diode_vis_2_mid<br>diode_vis_3_mid<br> | [`generators/uniform.py`](generators/uniform.py) | We set $D^V_1 / D^V_2 / D^V_3 = 0$ and sample all other manipulable variables as in `uniform_reference`. We collect $N = 1000$ measurements. |
| diode_ir_1_mid<br>diode_ir_2_mid<br>diode_ir_3_mid<br> | [`generators/uniform.py`](generators/uniform.py) | We set $D^I_1 / D^I_2 / D^I_3 = 1$ and sample all other manipulable variables as in `uniform_reference`. We collect $N = 1000$ measurements. |
| diode_ir_1_strong<br>diode_ir_2_strong<br>diode_ir_3_strong<br> | [`generators/uniform.py`](generators/uniform.py) | We set $D^I_1 / D^I_2 / D^I_3 = 0$ and sample all other manipulable variables as in `uniform_reference`. We collect $N = 1000$ measurements. |
| t_ir_1_weak<br>t_ir_2_weak<br>t_ir_3_weak<br>t_vis_1_weak<br>t_vis_2_weak<br>t_vis_3_weak<br> | [`generators/uniform.py`](generators/uniform.py) | We set $T^V_1,T^V_2,T^V_3,T^I_1,T^I_2,T^I_3 = 2$ and sample all other manipulable variables as in `uniform_reference`. We collect $N = 1000$ measurements. |
| t_ir_1_mid<br>t_ir_2_mid<br>t_ir_3_mid<br>t_vis_1_mid<br>t_vis_2_mid<br>t_vis_3_mid<br> | [`generators/uniform.py`](generators/uniform.py) | We set $T^V_1,T^V_2,T^V_3,T^I_1,T^I_2,T^I_3 = 1$ and sample all other manipulable variables as in `uniform_reference`. We collect $N = 1000$ measurements. |
| t_ir_1_strong<br>t_ir_2_strong<br>t_ir_3_strong<br>t_vis_1_strong<br>t_vis_2_strong<br>t_vis_3_strong<br> | [`generators/uniform.py`](generators/uniform.py) | We set $T^V_1,T^V_2,T^V_3,T^I_1,T^I_2,T^I_3 = 0$ and sample all other manipulable variables as in `uniform_reference`. We collect $N = 1000$ measurements. |
| osr_1_weak<br>osr_2_weak<br>osr_c_weak | [`generators/uniform.py`](generators/uniform.py) | We set $O_1, O_2, O_C = 2$ and sample all other manipulable variables as in `uniform_reference`. We collect $N = 1000$ measurements. |
| osr_1_mid<br>osr_2_mid<br>osr_c_mid | [`generators/uniform.py`](generators/uniform.py) | We set $O_1, O_2, O_C = 4$ and sample all other manipulable variables as in `uniform_reference`. We collect $N = 1000$ measurements. |
| osr_1_strong<br>osr_2_strong<br>osr_c_strong | [`generators/uniform.py`](generators/uniform.py) | We set $O_1, O_2, O_C = 8$ and sample all other manipulable variables as in `uniform_reference`. We collect $N = 1000$ measurements. |
